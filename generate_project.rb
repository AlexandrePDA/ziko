...
SOURCE_FILES = {
  ...
  'BlindLoup/Services'                     => %w[MusicService.swift AudioPlayerService.swift StoreKitService.swift GameHistoryService.swift],
  'BlindLoup/Utilities'                    => %w[AppColors.swift AppConstants.swift Extensions.swift],
  'BlindLoup/Views/Home'                   => %w[HomeView.swift PremiumPaywallView.swift HowToPlayView.swift GameHistoryView.swift GameModeCard.swift ClassicModeMenuView.swift SettingsView.swift],
  ...
  'BlindLoup/Views/Components'             => %w[PrimaryButton.swift SectionDividerLabel.swift TrackRowView.swift PlayerScoreRow.swift ProtectionScreen.swift],
}
...
# Add Assets.xcassets
assets_group = get_or_create_group(project, PROJECT_NAME)
assets_ref = assets_group.new_file("BlindLoup/Assets.xcassets")
...
[debug_config, release_config].each do |config|
  ...
  config.build_settings['CODE_SIGN_ENTITLEMENTS']         = "#{PROJECT_NAME}/BlindLoup.entitlements"
