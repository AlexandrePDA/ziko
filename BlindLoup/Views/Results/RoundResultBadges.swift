...
struct LegendeView: View {
    ...
    private let entries: [LegendEntry] = [
        LegendEntry(emoji: "👂", title: "L'OREILLE ABSOLUE",
        ...
        LegendEntry(emoji: "💯", title: "LE TÉMOIN GÊNANT",
                    condition: "Tu as trouvé toutes les musiques d’un joueur. Tu sais. Il sait que tu sais. Tout le monde sait que tu sais. Ambiance.",
                    color: Color.appGreyLight, isEndGame: true),
    ]
